...
function draw() {
    ...
    // Redraw snake box unit in new position based on most recent keystroke
    // Previous box popped below unless snake eats
    ...
    if (snakeX == food.x && snakeY == food.y) {
        ...
        //Don't remove tail, just add new head as below
    } else {
        // Rotating between pop and unshift prevents snake growing endlessly
        snake.pop(); //remove tail if snake has not eaten in redraw intervals
    }

    //Create a new head every increment 
    let newHead = {
        x: snakeX,
        y: snakeY
    }
